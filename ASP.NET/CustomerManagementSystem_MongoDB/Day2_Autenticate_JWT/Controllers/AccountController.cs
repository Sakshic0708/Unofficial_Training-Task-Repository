...
namespace Day2_Autenticate_JWT.Controllers
{
        ...
        public ActionResult Login(Login model)
        {
            ...
            try
            {
                ...
                if (objuser != null && !string.IsNullOrEmpty(objuser.Id.ToString()))
                {
                    ...
                    objResponse.access_tocken = Day2_Autenticate_JWT.Common.CommonMethod.GenerateJSONWebToken(objuser, Audiences, Users, Secret);
